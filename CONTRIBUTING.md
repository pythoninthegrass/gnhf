...
- Run `pnpm run lint`, `pnpm run format:check`, `pnpm run typecheck`, and `pnpm test` before pushing. The pipeline will run them again, but a fast local pass saves rounds.
